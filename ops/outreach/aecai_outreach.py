...
Worked at firms from ENR #60 to ENR #123. Acquired and ran a geotech firm.
Adopted AI tools at an ENR Top 200 firm — validated $1.85M in annual operational
value across 200 engineers. Tools stuck. Now runs Echology — modernizing technology
to optimize workflows for engineering firms, where it makes sense.

Echology is NOT a software company. It's a consulting practice that happens to build tools.
